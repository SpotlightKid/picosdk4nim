...
proc usbInit*(): bool {.importc: "tusb_init", discardable.}
...
proc sendKeyboardReport*(itf: UsbHidInterface, id: byte, modifiers: set[KeyModifier],
    key0: KeyboardKeypress = keyNone, key1: KeyboardKeypress = keyNone,
    key2: KeyboardKeypress = keyNone, key3: KeyboardKeypress = keyNone,
    key4: KeyboardKeypress = keyNone, key5: KeyboardKeypress = keyNone): bool =
